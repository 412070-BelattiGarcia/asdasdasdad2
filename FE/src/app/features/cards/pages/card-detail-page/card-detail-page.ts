...
@Component({
  ...
  imports: [RouterLink, PokemonCardComponent, LoadingSpinnerComponent, ButtonComponent],
  template: `
    <main class="p-6">
      <a routerLink="/cards" class="mb-6 inline-block text-sm text-blue-600 hover:text-blue-800">
