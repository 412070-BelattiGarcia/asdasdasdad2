    ...
    <div class="mx-auto max-w-lg">
      <div class="overflow-hidden rounded-xl bg-white shadow-xl">
        ...
        <div class="flex flex-col sm:flex-row">
          <div class="flex shrink-0 items-start justify-center bg-gray-50 p-4 sm:w-56">
            <img
          ...
          <div class="flex flex-1 flex-col gap-3 p-5">
            <div>
              <div class="flex items-start justify-between gap-2">
                ...
                @if (card().hp) {
                  <span class="shrink-0 rounded-full bg-red-100 px-3 py-1 text-sm font-bold text-red-600">
                    {{ card().hp }} HP
                  </span>
                }
              </div>
