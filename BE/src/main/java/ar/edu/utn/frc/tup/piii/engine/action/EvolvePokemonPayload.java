...
public class EvolvePokemonPayload implements GameActionPayload {
    private int handIndex;
    private UUID targetPokemonInstanceId;

    public EvolvePokemonPayload() {}

    public EvolvePokemonPayload(int handIndex, UUID targetPokemonInstanceId) {
